#ifndef AddressPanel_Included
#define AddressPanel_Included
...
/**
 * Type representing an address bar. Typing an article here and hitting ENTER will change
 * which article is currently displayed.
 */
