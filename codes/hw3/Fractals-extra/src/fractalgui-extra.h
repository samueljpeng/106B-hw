...
// uncomment if Flood Fill or Mandelbrot set fractal is enabled (default off for CS 106B)
#define TREE_ENABLED 1
//#define MANDELBROT_SET_ENABLED 1
//#define FLOOD_FILL_ENABLED 1

#ifdef MANDLEBROT_SET_ENABLED
#define COLOR_CHOOSER_ENABLED 1
#endif
