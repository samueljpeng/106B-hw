...
SOURCES *= $$files($$PWD/src/GUI/*.cpp)
SOURCES *= $$files($$PWD/src/Matchmaker/*.cpp)
SOURCES *= $$files($$PWD/src/ProcessOptimizer/*.cpp)
SOURCES *= $$files($$PWD/src/WaterLevel/*.cpp)
...
INCLUDEPATH *= $$PWD/src/Matchmaker/
INCLUDEPATH *= $$PWD/src/ProcessOptimizer/
INCLUDEPATH *= $$PWD/src/Testing/
INCLUDEPATH *= $$PWD/src/WaterLevel/
...
OTHER_FILES *= res/*
OTHER_FILES *= res/grids/*
OTHER_FILES *= res/hospitals/*
OTHER_FILES *= res/terrains/*
OTHER_FILES *= res/processes/*
OTHER_FILES *= res/processes/images/*
exists($$PWD/*.txt) {
