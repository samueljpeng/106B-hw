...
bool humanWordSearch(const Grid<char>& board, const Lexicon& dictionary, const std::string& word);

Set<std::string> computerWordSearch(const Grid<char>& board, const Lexicon& dictionary, const Set<std::string>& humanWords);
